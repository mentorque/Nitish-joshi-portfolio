  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "nitishjoshi04@gmail.com",
      href: "mailto:nitishjoshi04@gmail.com",
      primary: true
    },
    {
      icon: <Phone className="w-6 h-6" />,
      label: "Phone",
      value: "+353 894 980 613",
      href: "tel:+353894980613"
    },
    {
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Backend Software Developer with 1+ years of experience in Java-based RESTful systems and Spring Boot.
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-sm text-muted-foreground">
                    ...
                    <p>MSc Software Engineering (2:1)</p>
                    <p>2024 – 2025</p>
                  </div>
                </div>
